...
export function readLanguage(): Language { return localStorage.getItem(LANGUAGE_KEY) === 'en' ? 'en' : 'vi'; }
export function saveLanguage(language: Language) { localStorage.setItem(LANGUAGE_KEY, language); }
